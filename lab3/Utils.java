...
public class Utils {
    ...
    public static void saveGame(String fileName, List<Player> player, List<EnemyTank> enemy, List<Bullet> bullets,
    ...
    public static void saveRepeat(List<Player> player, List<EnemyTank> enemy, List<Bullet> bullets,
        List<Bullet> player1bullets, List<Bullet> player2bullets, List<Missile> missiles) {
        AppendingObjectOutputStream out = null;
        try {
            out = new AppendingObjectOutputStream(new FileOutputStream("objectsRepeat.dat", true));
        } catch (IOException e) {
            e.printStackTrace();
        }
        Date now = new Date(System.currentTimeMillis());
    ...
    //    public static void load(List<Player> player, List<EnemyTank> enemy, List<Bullet> bullets,List<Bullet>player1bullets,List<Bullet>player2bullets, List<Missile>missiles){
